        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Chatting to your PDF Files has never been easier before AIPDF
            </p>
          </div>
        </div>
        ...
        <ol className=" my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className=" md:flex-1">
            <div className=" flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-1-0 md:border-t-2 md:pb-0 md:pl-0 md-pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                Either starting out with an free plan or choose our{" "}
                <Link
                  href="/pricing"
          ...
          <li className=" md:flex-1">
            <div className=" flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-1-0 md:border-t-2 md:pb-0 md:pl-0 md-pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                It&apos;s that simple . Try out AIPDF Today. It really takes less then a minute
